...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'faceImport/list',
        component: () => import('@/views/user/faceImport/list'),
        name: 'UserFacePageList',
        meta: { title: '人脸处理', noCache: true }
      },
      {
        path: 'faceImport/edit',
        component: () => import('@/views/user/faceImport/edit'),
        name: 'UserFaceEdit',
        meta: { title: '人脸编辑', noCache: true, activeMenu: '/user/faceImport/list' },
        hidden: true
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'composePaper/edit',
        component: () => import('@/views/exam/composePaper/edit'),
        name: 'ExamQuestionPageCompose',
        meta: { title: '一键组卷', noCache: true }
      },
      {
