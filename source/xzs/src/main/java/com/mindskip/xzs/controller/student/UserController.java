...
public class UserController extends BaseApiController {
    ...
    public RestResponse<UserResponseVM> current() {
        ...
        System.out.println("这里是User user");
        System.out.println(user.getStuNo());
        UserResponseVM userVm = UserResponseVM.from(user);
        System.out.println("这里是UserResponseVM userVm");
    ...
    public RestResponse update(@RequestBody @Valid UserUpdateVM model) {
        ...
        System.out.println("这里是更更新" + model.getSchool() + model.getRealName() + model.getPhone() + model.getStuNo());
        User user = userService.selectById(getCurrentUser().getId());
        user.setSchool(model.getSchool());
        user.setStuNo(model.getStuNo());
