<template>
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" :rules="rules">
      ...
      <el-form-item label="难易程度：" prop="hardess">
        <el-select v-model="form.hardorNot" placeholder="难易程度">
          <el-option v-for="item in this.hardess" :key="item" :value="item"
                     :label="item"></el-option>
        </el-select>
      </el-form-item>
      <!-- <el-form-item label="组卷描述："  prop="composeInfo" >
        <el-input v-model="form.composeInfo" placeholder="仅支持一键组卷功能，描述模板：链表：11，图：32， 广义表：3， 哈夫曼树：40（注：数字代表分数）" />
      </el-form-item> -->
      ...
      <el-form-item>
        ...
        <!-- <el-button type="primary" @click="composePaper">一键组卷</el-button> -->
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        ...
        hardorNot: [
          { required: false, message: '请选择难易程度', trigger: 'change' }
        ],
        paperType: [
  ...
  methods: {
    ...
    composePaper () {
      ...
      //   { name: '标题1', questionItems: [] },
      //   { name: '标题2', questionItems: [] }
      // ]
      let _this = this
